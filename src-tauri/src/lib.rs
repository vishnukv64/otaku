...
pub fn run() {
  ...
  builder
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      jikan::commands::jikan_search_manga_filtered,
      jikan::commands::jikan_anime_characters,
      jikan::commands::jikan_anime_staff,
      jikan::commands::jikan_anime_statistics,
      jikan::commands::jikan_anime_reviews,
      jikan::commands::jikan_anime_pictures,
      jikan::commands::jikan_anime_news,
      jikan::commands::jikan_manga_characters,
      jikan::commands::jikan_manga_statistics,
      jikan::commands::jikan_manga_reviews,
      jikan::commands::jikan_manga_pictures,
      jikan::commands::jikan_manga_news,
      jikan::commands::jikan_manga_recommendations,
    ...
    .run(|_app_handle, _event| {
      ...
      if let tauri::RunEvent::Reopen { has_visible_windows, .. } = _event {
        if !has_visible_windows {
          tray::restore_and_navigate(_app_handle);
        }
      }
    });
}
